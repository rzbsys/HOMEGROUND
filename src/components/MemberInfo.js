    ...
    return (
        <div className="Member" onClick={MemberOnclick}>
            <div className="MemberProfileImage" style={{ backgroundColor: data["Color"] }}>
                {data["Image"]
                    ? <img src={`https://cdn.jsdelivr.net/gh/zawook/hgweb@master/RainStudio/MemberImage/${data["Image"].replaceAll(" ", "%20")}`} alt="" onError={(e) => { e.target.src = ErrImage; e.target.style["marginTop"] = "0px"; }} />
