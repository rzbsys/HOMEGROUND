        ...
        <div className="YoutubeModal CloseModal" ref={ModalRef}>
            ...
            <div className="YoutubeVideo MemberProfile" style={{ backgroundColor: MemberModalInfo["Color"] }}>
                {MemberModalInfo["Image"]
                    ? <img src={`https://cdn.jsdelivr.net/gh/zawook/hgweb@master/RainStudio/MemberImage/${MemberModalInfo["Image"].replaceAll(" ", "%20")}`} alt="" onError={(e) => { e.target.src = ErrImage; e.target.style["marginTop"] = "0px"; }} />
