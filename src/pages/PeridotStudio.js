        ...
        <>
            ...
            <Section>
                <AnimationOnScroll animateIn="fadeInDown" offset={50} >
                    <h1 className="w_4" style={{ color: "#A7E4C8" }}>안녕하세요.</h1>
                </AnimationOnScroll>

                <AnimationOnScroll animateIn="fadeInDown" offset={50} delay={200} >
                    <h1 className="w_4" style={{ color: "#5DEB98" }}>투렌드(Twollend)입니다.</h1>
                </AnimationOnScroll>

                <AnimationOnScroll animateIn="fadeInDown" offset={50} delay={400} >
                    <h1 className="w_4" style={{ color: "#52E18E" }}>소개페이지에 오신것을 환영합니다!</h1>
                </AnimationOnScroll>
